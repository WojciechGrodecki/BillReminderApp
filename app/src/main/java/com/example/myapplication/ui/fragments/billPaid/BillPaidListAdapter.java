...
public class BillPaidListAdapter extends ListAdapter<Bill, BillPaidListAdapter.TaskItemViewHolder> {
    ...
    public BillPaidListAdapter(@NonNull Resources resources) {
        super(DIFF_UTIL);
    ...
    public void onBindViewHolder(@NonNull TaskItemViewHolder holder, int position) {
        Bill bill = getItem(position);
            ...
            holder.linearLayout.setOnClickListener(v -> BillPaidFragment.setBillDetails(bill.getBillName(), bill.getBillPrice(), bill.getBillDate(), bill.getRepeat()));
